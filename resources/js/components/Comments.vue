<template>
    <div>
        ...
        <div v-for="comment in comments" v-bind:key="comment.id">
            ...
            <p>{{ comment.body }}</p>
            <button @click.prevent="editComment" class="btn btn-sm btn-deep-orange">
            ...
            <button @click.prevent="editComment" class="btn btn-sm btn-danger">
...
export default {
    ...
    methods: {
        ...
        editComment() {
            // Write comment to db for updateS
        }
    }
};
</script>
